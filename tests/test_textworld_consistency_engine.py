...
class RecordingModel:
    ...
    def __call__(
        self, input_ids, attention_mask, use_cache=False, logits_to_keep=None
    ):
        self.call_count += 1
...
class TextWorldConsistencyEngineTests(unittest.TestCase):
    def test_scores_real_and_predicted_observations_in_one_model_call(self):
        ...
        self.assertEqual(model.last_batch_size, 2)
