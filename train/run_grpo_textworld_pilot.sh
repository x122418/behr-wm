...
export REWARD_MODE="${REWARD_MODE:-cauchy}"
export OUTPUT_DIR="${OUTPUT_DIR:-${PROJECT_ROOT}/outputs/checkpoints/textworld_${REWARD_MODE}_pilot}"
export EXPERIMENT_NAME="${EXPERIMENT_NAME:-textworld-${REWARD_MODE}-pilot}"
